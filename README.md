...
sağlanmak istenmiştir
 ...
 Proje Lisansı: Bu proje GNU GPL v3.0 kapsamında lisanslanmıştır.

 Geliştirme Süreci: Bu proje Tuğra Yiğit tarafından geliştirilmiş olup "Claude Sonnet 4.6" yapay zeka modeli tarafından destek alınmıştır.
 (https://github.com/TugraYigitY)
